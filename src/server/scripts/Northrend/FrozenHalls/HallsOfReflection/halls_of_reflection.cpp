...
enum Text
{
	...
	EMOTE_UTHER_INTRO_H2_1				= 16, // custom
	EMOTE_UTHER_INTRO_A2_1				= 17, // custom
...
enum Events
{
    ...
    EVENT_INTRO_A2_2,
    EVENT_INTRO_A2_3,
	EVENT_INTRO_CAST_VISUAL_A, // custom
    EVENT_INTRO_A2_4,
    EVENT_INTRO_A2_5,
    EVENT_INTRO_A2_6,
    EVENT_INTRO_A2_7,
    ...
    EVENT_INTRO_A2_17,
    EVENT_INTRO_A2_18,
	EVENT_INTRO_A2_UTHER_EMOTE_1, // custom
    EVENT_INTRO_A2_19,

    EVENT_INTRO_H2_1,
    EVENT_INTRO_H2_2,
    EVENT_INTRO_H2_3,
	EVENT_INTRO_CAST_VISUAL_H, // custom
    EVENT_INTRO_H2_4,
    EVENT_INTRO_H2_5,
    EVENT_INTRO_H2_6,
    EVENT_INTRO_H2_7,
    ...
    EVENT_INTRO_H2_11,
    EVENT_INTRO_H2_12,
	EVENT_INTRO_H2_UTHER_EMOTE_1, // custom
    EVENT_INTRO_H2_13,
    EVENT_INTRO_H2_14,
    EVENT_INTRO_H2_15,

    EVENT_INTRO_LK_1,
	EVENT_INTRO_UTHER_COWER,
    EVENT_INTRO_LK_2,
    EVENT_INTRO_LK_3,
    EVENT_INTRO_LK_4,
	EVENT_INTRO_LK_FROSTMOURNE, // custom
    EVENT_INTRO_LK_5,
    EVENT_INTRO_LK_6,
	EVENT_INTRO_LK_MOVEAWAY, // custom
    EVENT_INTRO_LK_7,
    EVENT_INTRO_LK_8,
    EVENT_INTRO_LK_9,
    EVENT_INTRO_LK_10,
...
const Position IntroPosition            = {5265.89f, 1952.98f, 707.6978f, 0.883f};                // Jaina/Sylvanas Intro Start Position
const Position MoveThronePos            = {5306.952148f, 1998.499023f, 709.341431f, 1.277278f}; // Jaina/Sylvanas walks to throne
const Position UtherSpawnPosition            = {5308.277832f, 2003.343750f, 709.341431f, 4.474386f};
const Position LichKingSpawnPosition         = {5364.604492f, 2064.644775f, 707.695374f, 3.9515f};
const Position LichKingUtherDespawnPoz	= {5333.224609f, 2031.726929f, 707.694763f, 3.9515f};
const Position LichKingMoveThronePosition    = {5312.897461f, 2010.269165f, 709.341431f, 3.9515f}; // Lich King walks to throne
...
const Position LichKingFirstSum      = {5607.490723f, 2190.994141f, 730.996887f, 4.167572f}; // Lich King First summons
...
const Position FalricStartPos           = {5283.980469f, 2030.566406f, 709.319641f, 5.522377f}; // Falric start position
const Position MarwynStartPos           = {5334.863770f, 1982.277710f, 709.320129f, 2.382357f}; // Marwyn start position
...
class npc_jaina_or_sylvanas_hor : public CreatureScript
{
    ...
    struct npc_jaina_or_sylvanas_horAI : public ScriptedAI
    {
        ...
        void sGossipSelect(Player* player, uint32 /*sender*/, uint32 action) OVERRIDE
        {
            ...
            switch (action)
            {
                case 0:
                    ...
                    _events.ScheduleEvent(EVENT_START_INTRO, 1500);
                    me->RemoveFlag(UNIT_NPC_FLAGS, UNIT_NPC_FLAG_GOSSIP|UNIT_NPC_FLAG_QUESTGIVER);
                    break;
                case 1:
                    player->CLOSE_GOSSIP_MENU();
                    _events.ScheduleEvent(EVENT_SKIP_INTRO, 1500);
                    me->RemoveFlag(UNIT_NPC_FLAGS, UNIT_NPC_FLAG_GOSSIP|UNIT_NPC_FLAG_QUESTGIVER);
                    break;
            }
        }
        ...
        void Reset() OVERRIDE
        {
            ...
            _events.ScheduleEvent(EVENT_WALK_INTRO1, 2000);
        }
        ...
        void UpdateAI(uint32 diff) OVERRIDE
        {
            ...
            switch (_events.ExecuteEvent())
            {
                case EVENT_WALK_INTRO1:
					...
					me->GetMotionMaster()->MovePoint(0, IntroPosition);
                    break;
                case EVENT_WALK_INTRO2:
                    if (_instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
					{
                        Talk(SAY_JAINA_INTRO_2);
						me->SetFacingTo(0.883f);
                ...
                case EVENT_START_INTRO:
                    if (_instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
					{
                        _events.ScheduleEvent(EVENT_INTRO_A2_1, 12000);
					}
					
                    else
					{
                        _events.ScheduleEvent(EVENT_INTRO_H2_1, 12000);
					}
                ...
                case EVENT_INTRO_A2_3:
					...
					_events.ScheduleEvent(EVENT_INTRO_CAST_VISUAL_A, 3000);
                    break;
				case EVENT_INTRO_CAST_VISUAL_A:
                ...
                case EVENT_INTRO_A2_4:
                	...
                	if (Creature* Uther = me->SummonCreature(NPC_UTHER, UtherSpawnPosition, TEMPSUMMON_MANUAL_DESPAWN))
                	{
                ...
                case EVENT_INTRO_A2_5:
                    ...
                    _events.ScheduleEvent(EVENT_INTRO_A2_6, 4000);
                    break;
                case EVENT_INTRO_A2_6:
                    Talk(SAY_JAINA_INTRO_5);
                    _events.ScheduleEvent(EVENT_INTRO_A2_7, 7500);
                    break;
                ...
                case EVENT_INTRO_A2_12:
                    ...
                    _events.ScheduleEvent(EVENT_INTRO_A2_13, 5000);
                    break;
                ...
                case EVENT_INTRO_A2_17:
                    Talk(SAY_JAINA_INTRO_10);
             	    _events.ScheduleEvent(EVENT_INTRO_A2_UTHER_EMOTE_1, 5000);
                    break;
				case EVENT_INTRO_A2_UTHER_EMOTE_1:
					if (Creature* Uther = me->GetCreature(*me, _UtherGUID))
					{
						Uther->AI()->Talk(EMOTE_UTHER_INTRO_A2_1);
					}	
						
					_events.ScheduleEvent(EVENT_INTRO_A2_18, 2000);
					break;
                ...
                case EVENT_INTRO_H2_1:
					Talk(SAY_SYLVANAS_INTRO_2);
					me->SetFacingTo(1.277278f);
                    _events.ScheduleEvent(EVENT_INTRO_H2_2, 10000);
                    break;
                case EVENT_INTRO_H2_2:
					Talk(SAY_SYLVANAS_INTRO_3);
                    _events.ScheduleEvent(EVENT_INTRO_H2_3, 2500);
                    break;
                case EVENT_INTRO_H2_3:
                    me->CastSpell(me, SPELL_CAST_VISUAL, false);
					_events.ScheduleEvent(EVENT_INTRO_CAST_VISUAL_H, 3000);
                    break;
				case EVENT_INTRO_CAST_VISUAL_H:
					_instance->HandleGameObject(_instance->GetData64(DATA_FROSTMOURNE), true);
					me->CastSpell(me, SPELL_FROSTMOURNE_SOUNDS, true);
					_events.ScheduleEvent(EVENT_INTRO_H2_4, 10000);
					break;
                ...
                case EVENT_INTRO_H2_12:
                    ...
                    _events.ScheduleEvent(EVENT_INTRO_H2_UTHER_EMOTE_1, 5000);
                    break;
				case EVENT_INTRO_H2_UTHER_EMOTE_1:
					if (Creature* Uther = me->GetCreature(*me, _UtherGUID))
					{
						Uther->AI()->Talk(EMOTE_UTHER_INTRO_H2_1);
					}	
                ...
                case EVENT_INTRO_H2_15:
                    ...
                    _events.ScheduleEvent(EVENT_INTRO_LK_1, 5000);
                    break;
                case EVENT_INTRO_LK_1:
                    // Spawn Lich in front of door, and make him move to the sword.
                    if (Creature* Lich = me->SummonCreature(NPC_LICH_KING_PART1, LichKingSpawnPosition, TEMPSUMMON_MANUAL_DESPAWN))
                    {
                     	Lich->SetWalk(true);
                   	 	Lich->GetMotionMaster()->MovePoint(0, LichKingUtherDespawnPoz);
                     	_LichGUID = Lich->GetGUID();
                    ...
                    _events.ScheduleEvent(EVENT_CLOSE_FROSTWORN_DOOR, 3000);
					_events.ScheduleEvent(EVENT_INTRO_UTHER_COWER, 2000);
                    break;
				case EVENT_INTRO_UTHER_COWER:
					if (Creature* Uther = me->GetCreature(*me, _UtherGUID))
					{
						if (Creature* Lich = me->GetCreature(*me, _LichGUID))
						{
			 			Uther->SetFacingToObject(Lich);
                ...
                case EVENT_INTRO_LK_2:
                    if (Creature* Lich = me->GetCreature(*me, _LichGUID))
					{
                        Lich->AI()->Talk(SAY_LK_INTRO_1);
					}
					
                    _events.ScheduleEvent(EVENT_INTRO_LK_3, 3000);
                    break;
                case EVENT_INTRO_LK_3:
                    ...
                    if (Creature* Uther = me->GetCreature(*me, _UtherGUID))
                    {
                        ...
                        Uther->DespawnOrUnsummon(2000);
                        _UtherGUID = 0;
                    }
					
					if (Creature* Lich = me->GetCreature(*me, _LichGUID))
					{
						Lich->GetMotionMaster()->MovePoint(0, LichKingMoveThronePosition);
					}
					
					_events.ScheduleEvent(EVENT_INTRO_LK_4, 7000);
                    break;
                case EVENT_INTRO_LK_4:
                    if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                    {
						Lich->SetFacingTo(4.250f);
						Lich->AI()->Talk(SAY_LK_INTRO_2);
                    }
                    _events.ScheduleEvent(EVENT_INTRO_LK_FROSTMOURNE, 10000);
                    break;
				case EVENT_INTRO_LK_FROSTMOURNE:
					if (Creature* Lich = me->GetCreature(*me, _LichGUID))
					{
						Lich->SetFacingTo(3.9515f);
						Lich->HandleEmoteCommand(EMOTE_ONESHOT_SPELL_CAST_OMNI);
					}
					_events.ScheduleEvent(EVENT_INTRO_LK_5, 950);
					break;
                case EVENT_INTRO_LK_5:
                    if (Creature* Lich = me->GetCreature(*me, _LichGUID))
					{
                        Lich->CastSpell(Lich, SPELL_TAKE_FROSTMOURNE, true);
                        Lich->CastSpell(Lich, SPELL_FROSTMOURNE_VISUAL, true);
                    ...
                    _events.ScheduleEvent(EVENT_INTRO_LK_6, 4000);
                    break;
                case EVENT_INTRO_LK_6:
                    ...
                    if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                    {
                        Lich->AI()->Talk(SAY_LK_INTRO_3);
                    }
					
					_events.ScheduleEvent(EVENT_INTRO_LK_MOVEAWAY, 4500);
                    _events.ScheduleEvent(EVENT_OPEN_FROSTWORN_DOOR, 10000);
                    break;
				case EVENT_INTRO_LK_MOVEAWAY:
					if (Creature* Lich = me->GetCreature(*me, _LichGUID))
					{
                        Lich->GetMotionMaster()->MovePoint(0, LichKingMoveAwayPos);
					}
					
					_events.ScheduleEvent(EVENT_INTRO_LK_7, 5500);
					 break;
                case EVENT_INTRO_LK_7:
                    ...
                    _events.ScheduleEvent(EVENT_INTRO_LK_8, 3000);
                    break;
                ...
                case EVENT_INTRO_LK_9:
                    if (Creature* Falric = ObjectAccessor::GetCreature(*me, _instance->GetData64(DATA_FALRIC_EVENT)))
					{
						...
						Falric->SetUInt32Value(UNIT_NPC_EMOTESTATE, EMOTE_ONESHOT_READY1H);
					}
					
					if (Creature* Marwyn = ObjectAccessor::GetCreature(*me, _instance->GetData64(DATA_MARWYN_EVENT)))
					{
						Marwyn->SetUInt32Value(UNIT_NPC_EMOTESTATE, EMOTE_ONESHOT_READY1H);
					}
                ...
                case EVENT_INTRO_LK_10:
                    ...
                    _events.ScheduleEvent(EVENT_INTRO_LK_11, 6000);
                    break;
                case EVENT_INTRO_LK_11:
                    if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                    {
                        if (_instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
						{
                            Lich->AI()->Talk(SAY_LK_JAINA_INTRO_END);
						}
						
                        else
						{
                            Lich->AI()->Talk(SAY_LK_SYLVANAS_INTRO_END);
						}
                    }
                ...
                case EVENT_INTRO_END:
                    ...
                    if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                    {
                        Lich->DespawnOrUnsummon(5000);
                        _LichGUID = 0;
                    }
					
                    me->DespawnOrUnsummon(10000);
                    _events.ScheduleEvent(EVENT_CLOSE_FROSTWORN_DOOR, 2000);
                    break;
                case EVENT_SKIP_INTRO:
					...
					me->GetMotionMaster()->MovePoint(0, MoveThronePos);
                    _events.ScheduleEvent(EVENT_OPEN_FROSTWORN_DOOR, 1000);
                    _events.ScheduleEvent(EVENT_CLOSE_FROSTWORN_DOOR, 3000);
...
class npc_jaina_or_sylvanas_escape_hor : public CreatureScript
{
    ...
    struct npc_jaina_or_sylvanas_escape_horAI : public ScriptedAI
    {
        ...
        void MovementInform(uint32 type, uint32 pointId) OVERRIDE
        {
            ...
            switch (pointId)
            {
				case POINT_REMORSELESS_WINTER:
                	if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                	{
						Lich->AI()->Talk(SAY_LK_ESCAPE_9);
                		Lich->CastSpell(Lich, SPELL_REMORSELESS_WINTER, false);
						_events.ScheduleEvent(EVENT_ESCAPE_11, 5000);
						_events.ScheduleEvent(EVENT_NEAR_LEADER, 1000);
                	}
			}
		}
        ...
        void UpdateAI(uint32 diff) OVERRIDE
        {
            ...
            while (uint32 event = _events.ExecuteEvent())
            {
                ...
                {
                    case EVENT_ESCAPE:
                        if (Creature* Lich = me->SummonCreature(NPC_LICH_KING_PART2, LichKingSpawnPos2, TEMPSUMMON_MANUAL_DESPAWN))
                        {
                            me->Attack(Lich, true);
                            Lich->Attack(me, true);
                    ...
                    case EVENT_ESCAPE_1:
                        ...
                        if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                        {
                            ...
                            if (_instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
							{
                                Lich->AI()->Talk(SAY_LK_ESCAPE_1);
							}	
								
                            else
							{
                                Lich->AI()->Talk(SAY_LK_ESCAPE_2);
							}
                        }
						
						_events.ScheduleEvent(EVENT_ESCAPE_2, 10000);
                        break;
                    case EVENT_ESCAPE_2:
                        if (_instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
						{
                    ...
                    case EVENT_ESCAPE_3:
                        if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                        {
                            ...
                            if (_instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
							{
                                Lich->AI()->DoCast(Lich, SPELL_JAINA_ICEPRISON, true);
							}	
								
                            else
							{
                                Lich->AI()->DoCast(Lich, SPELL_SYLVANAS_DARKBINDING, true);
							}
                        }
                    ...
                    case EVENT_ESCAPE_4:
                        ...
                        _events.ScheduleEvent(EVENT_ESCAPE_5, 100);
                        break;
                    case EVENT_ESCAPE_5:
                        if (Creature* Lich = me->GetCreature(*me, _LichGUID))
						{
                        ...
                        _events.ScheduleEvent(EVENT_ESCAPE_6, 6000);
                        break;
                    case EVENT_ESCAPE_6:
						if (Creature* Lich = me->GetCreature(*me, _LichGUID))
						{
                    ...
                    case EVENT_ESCAPE_7:
                        if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                        {
							...
							if (_instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
							{
								Lich->RemoveAurasDueToSpell(SPELL_JAINA_ICEBARRIER);
							}
							
							else
							{
								Lich->RemoveAurasDueToSpell(SPELL_SYLVANAS_CLOAKOFDARKNESS);
							}
							
							Lich->HandleEmoteCommand(EMOTE_ONESHOT_BATTLE_ROAR);
						}
                    ...
                    case EVENT_ESCAPE_8:
					    if (Creature* Lich = me->GetCreature(*me, _LichGUID))
						{
							Lich->SetSpeed(MOVE_WALK, 2.0f);
							Lich->SetWalk(true);
                            Lich->GetMotionMaster()->MovePoint(0, NpcJainaOrSylvanasEscapeRoute[0]);
							if (_instance->GetData(DATA_TEAM_IN_INSTANCE) == HORDE)
							{
								Lich->AI()->Talk(SAY_LK_ESCAPE_6);
							}
						}
						
                        me->GetMotionMaster()->MovePoint(0, NpcJainaOrSylvanasEscapeRoute[0]);
                        _events.ScheduleEvent(EVENT_ESCAPE_9, 4000);
                        break;
                    case EVENT_ESCAPE_9:
						me->GetMotionMaster()->MovePoint(0, NpcJainaOrSylvanasEscapeRoute[1]);
                        _events.ScheduleEvent(EVENT_ESCAPE_10, 4000);
                        break;
                    case EVENT_ESCAPE_10:
					    if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                        {
							Lich->GetMotionMaster()->MovePoint(POINT_REMORSELESS_WINTER, LichKingFirstSum);
						}
                        break;
                    case EVENT_ESCAPE_11:
                        if (Creature* Lich = me->GetCreature(*me, _LichGUID))
						{
							...
							Lich->AI()->DoCast(me, SPELL_RAISE_DEAD);
						}
						
						me->GetMotionMaster()->MovePoint(0, NpcJainaOrSylvanasEscapeRoute[2]);
                        _events.ScheduleEvent(EVENT_ESCAPE_12, 3000);
                        break;
                    case EVENT_ESCAPE_12:
                        if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                        {
                            Lich->Attack(me, true);
                            Lich->GetMotionMaster()->MoveIdle();
                            Lich->GetMotionMaster()->MoveChase(me);
                        }
                        ...
                        _events.ScheduleEvent(EVENT_ESCAPE_13, 1000);
                        break;
                    case EVENT_ESCAPE_13:
                        if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                        {
                            Lich->AI()->DoCast(Lich, SPELL_SUMMON_RISE_WITCH_DOCTOR);
							Lich->AI()->Talk(SAY_LK_ESCAPE_7);
							Lich->SetSpeed(MOVE_RUN, 2.0f);
							Lich->SetWalk(false);
                            Lich->GetMotionMaster()->MoveIdle();
                            Lich->GetMotionMaster()->MoveChase(me);
                        }
                    ...
                    case EVENT_ESCAPE_20:
                            ...
                            if (GameObject* icewall = walltarget->FindNearestGameObject(GO_ICE_WALL, 50.00f))
                            {
                                ...
                                if (_instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
                                {
                                    ...
                                    else if (_icewall == 2)
									{
										if (Creature* Lich = me->GetCreature(*me, _LichGUID))
										{
											Lich->AI()->Talk(SAY_LK_ESCAPE_4);
										}
                                        me->AI()->Talk(SAY_JAINA_ESCAPE_7);
									}
									...
									else if (_icewall == 4)
									{
										if (Creature* Lich = me->GetCreature(*me, _LichGUID))
										{
											Lich->RemoveAurasDueToSpell(SPELL_REMORSELESS_WINTER);
											Lich->SetWalk(true);
											Lich->SetSpeed(MOVE_WALK, 2.0f);
										}
                        ...
                        if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                        {
							...
							{
                                Lich->AI()->DoCast(Lich, SPELL_SUMMON_LUMBERING_ABOMINATION);
							}
                        }
                    ...
                    case EVENT_ESCAPE_23:// FINAL PART
                        ...
                        if (Creature* Lich = me->GetCreature(*me, _LichGUID))
                        {
                            Lich->GetMotionMaster()->MovePoint(0, LichKingFinalPos);
                        }
